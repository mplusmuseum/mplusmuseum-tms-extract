...
router.get('/:lang/admin/delete/:index/ByIds', ensureLoggedIn, admin.deleteIndexByIds)
router.post('/:lang/admin/delete/:index/ByIds', ensureLoggedIn, admin.deleteIndexByIds)
...
router.post('/:lang/admin/translations/:site', ensureLoggedIn, admin.translations.site)
router.get('/:lang/admin/translations/:site/download/strings', ensureLoggedIn, admin.translations.download)
...
router.post('/:lang/explore-o-matic', ensureLoggedIn, exploreomatic.index)
router.get('/:lang/explore-o-matic/search/:query', ensureLoggedIn, exploreomatic.index)
router.get('/:lang/explore-o-matic/search/:query/page/:page', ensureLoggedIn, exploreomatic.index)
...
router.get('/:lang/explore-o-matic/objectNames', ensureLoggedIn, exploreomatic.objectNames)
router.get('/:lang/explore-o-matic/objectStatuses', ensureLoggedIn, exploreomatic.objectStatuses)
router.get('/:lang/explore-o-matic/collectionTypes', ensureLoggedIn, exploreomatic.collectionTypes)
router.get('/:lang/explore-o-matic/collectionCodes', ensureLoggedIn, exploreomatic.collectionCodes)
router.get('/:lang/explore-o-matic/collectionNames', ensureLoggedIn, exploreomatic.collectionNames)
router.get('/:lang/explore-o-matic/departments', ensureLoggedIn, exploreomatic.departments)
router.get('/:lang/explore-o-matic/styles', ensureLoggedIn, exploreomatic.styles)
...
router.post('/:lang/explore-o-matic/objectNumber/:filter', ensureLoggedIn, exploreomatic.getObject)
...
router.get('/:lang/explore-o-matic/archive/:filter', ensureLoggedIn, exploreomatic.getObject)
router.post('/:lang/explore-o-matic/archive/:filter', ensureLoggedIn, exploreomatic.getObject)
