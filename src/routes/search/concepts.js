...
exports.index = async (req, res) => {
  ...
  const processFilename = path.join(rootDir, 'imports', 'Concepts', tms, 'process', subFolder, `${id}.json`)
  const processedFilename = path.join(rootDir, 'imports', 'Concepts', tms, 'processed', subFolder, `${id}.json`)
  const perfectFilename = path.join(rootDir, 'imports', 'Concepts', tms, 'perfect', subFolder, `${id}.json`)
  const xmlFilename = path.join(rootDir, 'imports', 'Concepts', tms, 'xml', subFolder, `${id}.xml`)
  ...
  return res.render('search/concepts', req.templateValues)
}
